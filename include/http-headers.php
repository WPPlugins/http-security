...
add_action( 'send_headers', 'add_security_header' );
function add_security_header() {
	...
	if ( get_option( 'http_security_csp_flag' ) ) {
		...
		if ( get_option( 'http_security_csp_block_all_mixed_content' ) ) $header_string .= ' block-all-mixed-content '. get_option( 'http_security_csp_block_all_mixed_content' ).';';
		...
		if ( get_option( 'http_security_csp_upgrade_insecure_requests' ) ) $header_string .= ' upgrade-insecure-requests '. get_option( 'http_security_csp_upgrade_insecure_requests' ).';';
